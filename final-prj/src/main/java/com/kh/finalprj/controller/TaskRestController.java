...
public class TaskRestController {
	...
	public boolean update(@RequestBody TaskDto taskDto, @CurrentUser TokenParseResponseVO parseVO) {
		...
		if (result && taskDto.getProjectNo() > 0) {
			simpMessagingTemplate.convertAndSend("/public/projects/" + taskDto.getProjectNo() + "/kanban",
					Map.of("eventType", "TASK_UPDATED", "projectNo", taskDto.getProjectNo(), "taskNo",
							taskDto.getTaskNo(), "senderEmpNo", senderEmpNo));
		}
